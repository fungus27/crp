...
int md5_init(unsigned char *state) {
...
int md5_update(unsigned char *state, unsigned char *message, unsigned int m_len) {
    static const uint32_t shifts[64] = {
        7, 12, 17, 22,  7, 12, 17, 22,  7, 12, 17, 22,  7, 12, 17, 22,
        5,  9, 14, 20,  5,  9, 14, 20,  5,  9, 14, 20,  5,  9, 14, 20,
        4, 11, 16, 23,  4, 11, 16, 23,  4, 11, 16, 23,  4, 11, 16, 23,
...
int md5_final(unsigned char *state, unsigned char *rest, unsigned int rest_len, unsigned char *md, unsigned int *md_len) {
    uint64_t *len = (uint64_t*)(state + 16);
    *len += rest_len * 8;
    rest[rest_len] = 0x80;
    if (rest_len >= 56) {
